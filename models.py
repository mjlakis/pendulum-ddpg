...
class Model():
	def __init__(self):
		# currently using asctec hummingbird. 
		# model parameters form: http://wiki.asctec.de/display/AR/CAD+Models
		self.m	 	= 0.53057				# total mass [kg]
		self.g 		= 9.81					# acceleration of gravity [m/s^2]
		self.Ix 	= 3.676e-3				# longitudinal inertia [kgm^2]
		self.Iy 	= 3.676e-3				# lateral inertia [kgm^2]
		self.Iz		= 7.031e-3				# vertial inertia [kgm^2]
		self.Jr  	= 6e-5					# rotor inertia [kgm^2]
		self.l   	= 0.17					# arm length [m]
		...
		# our thrust and momemnt values from: "Design and development of high performance control" thesis by william neely
		self.ct     = 6.11e-8				# N/(rpm)**2
		self.cq     = 1.5e-9				# N/(rpm)**2
